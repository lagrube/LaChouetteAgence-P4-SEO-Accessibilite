...
Le site optimisé hébergé sur GitHub: [La Chouette agence](https://github.com/lagrube/LaChouetteAgence-P4-SEO-Accessibilite/)
...
Le sujet porte sur l'optimisation du site [La Chouette agence](https://github.com/lagrube/LaChouetteAgence-P4-SEO-Accessibilite), (hébergé sur GitHub) via la mise en œuvre de 10 recommandations SEO.
...
* Le site avant optimisation : [La Chouette agence](https://github.com/lagrube/LaChouetteAgence-P4-avant-modif)
